...
- Ziv's strategy at unbounded precision is unproven to terminate
  ...
  (`sin`, `cos`, `tan`, `sinh`, `cosh`, `asinh`, `acosh`, `atanh`,
  `erfc`, `gamma`, `digamma`, `beta`, `Ei`, `Si`, `Ci`, `li`, `Ai`,
  `Bi`, `Ai_prime`, `Bi_prime`, `Y0`, `Y1`, `Yn`, `I0`, `I1`, `In`,
  `K0`, `K1`, `Kn`, `zeta`, `agm`) carry the original caveat until
  their Phase 1f family slice extends the driver to them. Slice
  p1.24 (elementary completions: `expm1`, `log1p`, `exp2`,
  `exp10`) and slice p1.25 (inverse trig: `asin`, `acos`, `atan`,
  `atan2`) are the migrations shipped so far; subsequent families
  follow per the audit at
