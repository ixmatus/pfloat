...
- Ziv's strategy at unbounded precision is unproven to terminate
  ...
  (`erfc`, `gamma`, `digamma`, `beta`, `Ei`, `Si`, `Ci`, `li`,
  ...
  p1.26 (forward trig: `sin`, `cos`, `tan`), and p1.27 (hyperbolic
  and inverse hyperbolic: `sinh`, `cosh`, `asinh`, `acosh`,
  `atanh`) are the migrations shipped so far; subsequent families
